...
### Biofuels from the first generation to sophisticated, circular pathways 
1.1 Technological progress 
While traditional biofuels (first-generation ethanol and biodiesel made from food crops) are still significant, recent advancements have concentrated on second- and third-generation pathways that utilize lignocellulosic residues, industrial off-gases, and engineered microbial gas fermentation. Important technological advancements include: 
Gas fermentation and CO/CO2 feedstocks: Businesses can employ anaerobic, gas-fermenting bacteria to transform industrial waste gases (steel mill off-gas, syngas) into ethanol and other alcohols. With flagship plants (such as LanzaTech collaborations) consistently sending ethanol from steel/process gas streams—a crucial demonstration of the commercial viability of circular biofuel ideas—demonstration and scale-up advanced in 2023–2024. 
LanzaTech 
+1 
Cellulosic ethanol and advanced fermentation: Enhanced pretreatment chemistries, custom cellulases, and consolidated bioprocessing ideas have decreased enzyme loadings and capital intensity. The technology is maturing, although still susceptible to feedstock logistics and policy incentives, as shown by pilot commercial plants and selective refinery conversions (and a mixed picture of starts/stops in the sector). 
